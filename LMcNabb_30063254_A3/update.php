...
<html lang="en">
  <head>
    ...
    <title>SCP Subject Files PHP</title>
  ...
  <body>
    ...
    <div class="m-2 border shadow">
        <div class="container-bg" style="margin-left: 50px; margin-right: 50px; background-color: rgb(227, 227, 227);">
                <div class="container">
                    <h1>Update a Subject's information in the database:</h1>
                    <br>
                    <form method="post" action="connection.php" class="form-group">
                      <input type="hidden" name="id" value="<?php echo $array['id']; ?>">
                      <label>ID: <?php echo $array['id']; ?> </label>
                      <br>
                      ...
                      <br>
                      <textarea name="contain" class="form-control">"<?php echo $array['contain']; ?>"</textarea>
                      <br><br>
                      <label>Enter Description:</label>
                      <br>
                      <textarea name="descri" class="form-control">"<?php echo $array['descri']; ?>"</textarea>
                      <br><br>
